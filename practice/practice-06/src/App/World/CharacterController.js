...
export default class CharacterController {
  ...
  instantiateController() {
    ...
    this.colliderType = this.physics.rapier.ColliderDesc.cuboid(1, 3.4, 1);
  ...
  loop() {
    ...
    if (movement.length() !== 0) {
      ...
      this.character.quaternion.slerp(characterRotation, 0.3);
    }
    ...
    this.character.position.lerp(this.rigidBody.translation(), 0.3);
  }
}
