...
const rectLight1 = new THREE.RectAreaLight(0xd6025e, 3, 3, 3);

rectLight1.position.set(4, 2, 3);
rectLight1.lookAt(-2, 0, -2);
...
const rectLight1Pane = pane.addFolder({
  title: "RectArea Light",
  extended: true,
});

rectLight1Pane.addInput(rectLight1, "color", { color: { type: "float" } });
rectLight1Pane.addInput(rectLight1, "position", {
  x: { min: -10, max: 10, step: 1 },
  y: { min: -10, max: 10, step: 1 },
  z: { min: -10, max: 10, step: 1 },
});

rectLight1Pane.addInput(rectLight1, "width", { min: 0, max: 100, step: 0.01 });
rectLight1Pane.addInput(rectLight1, "height", { min: 0, max: 100, step: 0.01 });
rectLight1Pane.addInput(rectLight1, "intensity", {
  min: 0,
  max: 5,
  step: 0.01,
});

const rectLight2 = new THREE.RectAreaLight(0x1923e0, 3, 3, 3);
...
const rectLight2Pane = pane.addFolder({
  title: "RectArea Light",
  extended: true,
});

rectLight2Pane.addInput(rectLight2, "color", { color: { type: "float" } });
rectLight2Pane.addInput(rectLight2, "position", {
  x: { min: -10, max: 10, step: 1 },
  y: { min: -10, max: 10, step: 1 },
  z: { min: -10, max: 10, step: 1 },
});

rectLight2Pane.addInput(rectLight2, "width", { min: 0, max: 100, step: 0.01 });
rectLight2Pane.addInput(rectLight2, "height", { min: 0, max: 100, step: 0.01 });
rectLight2Pane.addInput(rectLight2, "intensity", {
  min: 0,
  max: 5,
  step: 0.01,
});
