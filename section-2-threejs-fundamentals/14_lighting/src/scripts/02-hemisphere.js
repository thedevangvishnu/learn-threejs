...
const hemispherePane = pane.addFolder({
  title: "Hemisphere Light",
  expanded: true,
});

hemispherePane.addInput(hemisphereLight, "color", {
  color: { type: "float" },
});

hemispherePane.addInput(hemisphereLight, "groundColor", {
  color: { type: "float" },
});

hemispherePane.addInput(hemisphereLight, "intensity", {
  min: 0,
  max: 1,
  step: 0.01,
});
