...
const pointLight = new THREE.PointLight("whtie", 0.7);
...
const pointPane = pane.addFolder({
  title: "Point Light",
  extended: true,
});
pointPane.addInput(pointLight, "color", {
  color: { type: "float" },
});
pointPane.addInput(pointLight, "intensity", {
  min: 0,
  max: 1,
  step: 0.01,
});
