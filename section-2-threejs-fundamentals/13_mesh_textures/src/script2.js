...
const graassTexture = textureLoader.load(
  "/textures/whispy-grass-meadow-bl/wispy-grass-meadow_albedo.png"
);
graassTexture.repeat.set(10, 10);
graassTexture.wrapS = THREE.RepeatWrapping;
graassTexture.wrapT = THREE.RepeatWrapping;

// initialize the material
const material = new THREE.MeshBasicMaterial();
material.side = THREE.DoubleSide;
material.map = graassTexture;
